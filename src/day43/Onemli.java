...
public class Onemli {
	...
	public static void main(String[] args) {
        ...
        System.out.println("Total Memory:"+rt.totalMemory());//makina hafizsi kapazitesi
        System.out.println("Loop tan once Free Memory:"+rt.freeMemory());//makinadaki bos alan
