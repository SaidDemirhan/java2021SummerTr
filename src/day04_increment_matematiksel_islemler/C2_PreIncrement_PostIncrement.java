...
public class C2_PreIncrement_PostIncrement {
	...
	public static void main(String[] args) {
		...
		int sayi2=++sayi1; 	// 21	önce arttir sonra islem yap
		
		
		System.out.println("pre increment sayi1: " + sayi1);	//21
		System.out.println("pre increment say2: " + sayi2);		//21
		...
		int sayi3=10;
		System.out.println("pre increment" + ++sayi3);	//11	önce arttir sonra yazdir
		System.out.println("post increment" + sayi3++);	//11	önce yazdir sonra arttir
